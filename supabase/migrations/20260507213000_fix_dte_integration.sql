-- Fix DTE references and make generation graceful
-- 1. Add Foreign Keys for relationship resolution in Supabase (fixes 400 error)
ALTER TABLE "pharmacy"."dte_documents" 
DROP CONSTRAINT IF EXISTS "dte_documents_sale_id_fkey",
DROP CONSTRAINT IF EXISTS "dte_documents_customer_id_fkey";

ALTER TABLE "pharmacy"."dte_documents" 
ADD CONSTRAINT "dte_documents_sale_id_fkey" 
FOREIGN KEY ("sale_id") REFERENCES "pharmacy"."sales"("id");

ALTER TABLE "pharmacy"."dte_documents" 
ADD CONSTRAINT "dte_documents_customer_id_fkey" 
FOREIGN KEY ("customer_id") REFERENCES "pharmacy"."patients"("id");

-- 2. Make generate_internal_dte idempotent
...
-- 3. Update process_pharmacy_sale to handle DTE generation gracefully
...
begin
  ...
  -- GENERAR DTE INTERNO AUTOMÁTICAMENTE (Graceful)
  begin
