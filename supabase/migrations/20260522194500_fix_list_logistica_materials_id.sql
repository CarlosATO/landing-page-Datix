...
begin
  ...
  from (
    select
      ...
      li.description,
      li.item_type,
      li.catalog_item_kind,
      li.catalog_is_active,
      li.default_cost,
      li.default_tax_rate,
      li.catalog_metadata,
      li.catalog_unit,
    ...
    where li.company_id = v_company_id
      ...
      and (
        ...
        or upper(coalesce(li.category_name, '')) like '%' || upper(v_search) || '%'
      )
      and (v_item_kind is null or lower(coalesce(li.catalog_item_kind, li.item_type)) = v_item_kind)
